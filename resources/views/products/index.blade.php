...
@push('styles')
    ...
    <style>
        .product-image-thumb { width: 50px; height: 50px; object-fit: cover; border-radius: 5px; }
    </style>
@endpush
    ...
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                <button type="button" class="btn btn-primary" id="addNewProductBtn"><i class="bx bx-plus me-1"></i> Add New Product</button>
            </div>
        </div>
    </div>
</div>
...
@push('scripts')
    ...
    {{-- This is the ONLY place we should include the page's JavaScript --}}
